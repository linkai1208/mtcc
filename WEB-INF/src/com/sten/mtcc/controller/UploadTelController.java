 ...
 */
@RestController
@RequestMapping(value = "uploadTel")
public class UploadTelController {
	...
	public Map<String, Object> saveOrUpdateListfile(BzTelCostIndex model)
		...
		costIndex.setPre_compare_status("0");
		costIndex.setCompare_status("0");
	...
	@RequestMapping(value = "view/compare")
	public ModelAndView view_compare(String uuid) {
		ModelAndView mv = new ModelAndView();

		BzTelCostIndex index = uploadTelService.getTelCostIndexById(uuid);
		String period_year = index.getPeriod_year();
		String period_month = index.getPeriod_month();
		mv.addObject("period_year", period_year);
		mv.addObject("period_month", period_month);
		mv.setViewName("mtcc/compare/compareTelCost");
		return mv;
	}

	@RequestMapping(value = "compare", method = RequestMethod.POST)
	public Map<String, Object> compare(String uuid) {
		Map<String, Object> map = new HashMap<String, Object>();
		boolean flg = false;
		BzTelCostIndex index = uploadTelService.getTelCostIndexById(uuid);
		String period_year = index.getPeriod_year();
		...
		uploadTelService.compare(uuid, period_year, period_month);
	...
	@RequestMapping(value = "view/preprocess")
	public ModelAndView view_preprocess(String uuid) {
		ModelAndView mv = new ModelAndView();
		...
		mv.addObject("period_year", period_year);
		mv.addObject("period_month", period_month);
		mv.setViewName("mtcc/compare/processTelCost");
		return mv;
	}

	@RequestMapping(value = "preprocess", method = RequestMethod.POST)
	public Map<String, Object> preprocess(String uuid) {
		Map<String, Object> map = new HashMap<String, Object>();
		boolean flg = false;
		BzTelCostIndex index = uploadTelService.getTelCostIndexById(uuid);
		String period_year = index.getPeriod_year();
		...
		uploadTelService.initial(uuid, period_year, period_month);
